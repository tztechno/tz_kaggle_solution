...
4つに分割した画像間でのマッチングのためにmatcher_thとmin_matchesを調整し、透明な物体と不透明な物体の両方に対してCVとLBを改善しました。

#### パイプライン
データセットが透明な物体かどうかを判断するために、データセット内の全ての画像の平均画像と各画像との間の平均正規化相関係数のしきい値を0.7に設定しました。
